...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("Box2D.compat.wasm");
  }
...
var wasmImports = {
  ...
  /** @export */ a: ___handle_stack_overflow,
  /** @export */ J: __abort_js,
  /** @export */ t: __embind_finalize_value_object,
  /** @export */ F: __embind_register_bigint,
  ...
  /** @export */ z: __embind_register_constant,
  /** @export */ N: __embind_register_emval,
  /** @export */ A: __embind_register_enum,
  /** @export */ n: __embind_register_enum_value,
  /** @export */ E: __embind_register_float,
  /** @export */ b: __embind_register_function,
  ...
  /** @export */ H: __emscripten_runtime_keepalive_clear,
  /** @export */ l: __emval_as,
  /** @export */ w: __emval_call,
  /** @export */ S: __emval_call_method,
  /** @export */ e: __emval_decref,
  /** @export */ y: __emval_get_global,
  /** @export */ v: __emval_get_method_caller,
  /** @export */ j: __emval_get_property,
  /** @export */ s: __emval_incref,
  /** @export */ M: __emval_instanceof,
  /** @export */ q: __emval_new_array,
  /** @export */ k: __emval_new_cstring,
  /** @export */ R: __emval_new_object,
  /** @export */ h: __emval_run_destructors,
  /** @export */ r: __emval_set_property,
  /** @export */ i: __emval_take_value,
  /** @export */ I: __setitimer_js,
...
var ___wasm_call_ctors = wasmExports["V"];

var ___getTypeName = wasmExports["W"];

var _malloc = Module["_malloc"] = wasmExports["X"];

var _free = Module["_free"] = wasmExports["Y"];

var _emscripten_stack_get_end = wasmExports["_"];

var _emscripten_stack_get_base = wasmExports["$"];

var __emscripten_timeout = wasmExports["aa"];

var _emscripten_stack_init = wasmExports["ba"];
...
var ___set_stack_limits = Module["___set_stack_limits"] = wasmExports["fa"];
